    ...
    <div class="top">
        ...
        <div class="title-bar">
          ...
          <a-popover placement="bottom">
            ...
            <a-button class="btn-title"><router-link to="/index/addproduct">发布商品</router-link></a-button>
        </div>
        <ul class="info-bar" id="shop-info-list">
            <li class="info-item">
                <div class="txt-name">昨日浏览量</div>
                <div class="txt-num">{{shopInfo.pageview}}</div>
            </li>
            <li class="info-item">
                <div class="txt-name">昨日访客数</div>
                <div class="txt-num">{{shopInfo.visitors}}</div>
            </li>
            <li class="info-item">
                <div class="txt-name">昨日商品浏览量</div>
                <div class="txt-num">{{shopInfo.goodsPageview}}</div>
            </li>
            <li class="info-item">
                <div class="txt-name">昨日商品访客数</div>
                <div class="txt-num">{{shopInfo.goodsVisitor}}</div>
            </li>
            <li class="info-item">
                <div class="txt-name">微页面</div>
                <div class="txt-num">{{shopInfo.minPage}}</div>
            </li>
            <li class="info-item">
                <div class="txt-name">商品</div>
                <div class="txt-num">{{shopInfo.goods}}</div>
            </li>
